...
4. Kein Spamming oder Flooding.
5. Einhaltung der Kanalthemen (nutzt den Sinner-Talk).
6. Kein Werben ohne Erlaubnis.
7. Verwendung angemessener Nicknamen und Avatare.
8. Feedback muss konstruktiv sein. Hetze führt zum Ausschluss.
9. Respektierung der Moderationsentscheidungen.
10. Datenschutz: Keine privaten Daten (Telefonnummern etc.) teilen.
11. Der Spaß am gemeinsamen Projekt steht im Vordergrund.

## Community Selbstverständnis
- Mitglieder werden OOC nicht ohne Einverständnis kontaktiert.
- Konflikte werden durch konstruktiven Dialog oder das Support-Team gelöst.
- Verstöße können zu Verwarnungen oder permanentem Ausschluss führen.
- Mitglieder tragen aktiv zum Wohl der Community bei (Events, Hilfe für Neue).
...
- **Discord-Name:** Muss mit den RedM-Einstellungen übereinstimmen.
...
- **Staatliche Ärzte:** Erhalten Paycheck, Zugang zu Med-Drogen (Morphin/Koks).
- **Private Ärzte:** Kein staatliches Geld, Handel auf eigenes Risiko.
- **Verboten:** Psychologen, Frauenärzte, Therapeuten (Gefahr des Missbrauchs).
- **Krankheiten:** Schwangerschaften und sexuelle Erkrankungen sind verboten.
